...
module.exports = async function (deployer, network, accounts) {
  ...
  // await deployer.deploy(NewMineForNode, wnew, newPerBlock, startBlock, startBlock+oneYearBlock, maintainer);
  // const newMine = await NewMineForNode.deployed();
  ...
  // TestNET  需要修改，下面的id=0还是nu-new交易对
  ...
  // 激活矿池
  // const newMine = await NewMineForNode.at("");
  // const newPerBlock = web3.utils.toWei("1", 'ether');
  // const number = await web3.eth.getBlockNumber();
  // console.log(number)
  ...
  // const newMine = await NewMineForNode.at("0x665d01B3757d530dC136942b94B16b27bf1d1c8b");
